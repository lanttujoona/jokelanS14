...
function bst_enqueues()
{
	...
	wp_enqueue_style('bootstrap-css');
  	...
  	wp_register_style('bst-css', get_template_directory_uri() . '/css/mainstyle.css', false, null);
	...
	wp_register_script('bootstrap-hover-dropdown-js', get_template_directory_uri() . '/js/bootstrap-hover-dropdown.js', false, null, true);
    wp_enqueue_script('bootstrap-hover-dropdown-js');

    wp_register_script('bst-js', get_template_directory_uri() . '/js/startupscript.js', false, null, true);
